  ...
  fetch("/account.json")
    ...
    .then((data) => {
      ...
      if (data.account === null) {
        ...
        accountContainerSmall.innerHTML = `<span class="p-navigation__link"><i class="p-icon--user is-light">${data.account.fullname}</i>(<a href="/logout${queryString}" class="p-link--inverted">logout</a>)</span>`;
